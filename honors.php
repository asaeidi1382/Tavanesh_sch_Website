...
<main class="content">
  ...
  <aside class="sidebar" id="sidebar">
    ...
    <h1 style="font-size:2.2rem; margin-bottom:24px; color:var(--turquoise-dark);">تالار افتخارات</h1>
<!-- تصاویر وسط‌چین شده -->
    <div class="images-container">
<p>تحسین شده توسط تیمهای کارشناسی مدیریت آموزش و پرورش</p>
<p>کسب رتبه عالی در تجهیزات آموزشی پیشرفته</p>
<p>پیاده سازی&nbsp; سیستم حقوق و دستمزد برای اولین بار در شهرستان و منطقه</p>
<p>&nbsp;.....</p>

دبیرستان توانش با استفاده از مدرن‌ترین تکنولوژی هاو کلاس‌هایی تمام هوشمند
 که مجهز به پروژکتورهای پیشرفته و دارای قلم هوشمند اختصاصی جهت ایجاد فضایی جذاب و تعاملی کلاسهای درس را موثر تر کرده است.
 <br>
 <br>

این دبیرستان دارای شبکه داخلی می باشد که ارتباط آسانی بین تجهیزات ، کلاسها ،دوربین ها و.....ایجاد کرده است.

 <br>
 <br>

راه اندازی وبسایت اختصاصی، بستر آموزش و تعامل با دانش آموزان را از کلاس درس فیزیکی فراتر برده است
 <br>
 <br>

در زمانی که شرایط برگزاری کلاسهای حضوری فراهم نباشد ،  با استفاده از سامانه آموزشی آنلاین اختصاصی بستری صد در درصد تعاملی
جهت برگزاری کلاسهای انلاین ایجاد گردیده است.
 <br>

امکانات ورزشی متعددی مانند میز پینگ‌ پنگ ،فوتبال دستی،زمین بدمینتون  و انواع لوازم ورزشی محیط را برای دانش آموزان جذاب تر و شاداب تر گردانده است.

<p>این لیست به زودی به روزرسانی و تکمیل تر می گردد...&nbsp;</p>
<p>&nbsp;</p>
<p>&nbsp; </p>
<p>&nbsp; </p>
    </div>
