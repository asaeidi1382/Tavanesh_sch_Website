...
<head>
  ...
  <title>دبیرستان دخترانه توانش — خدمات به سایر مدارس</title>
  ...
  <style>
    ...
    *{ box-sizing: border-box; margin:0; padding:0; }
    body{
      ...
      line-height: 1.7;
      position: relative;
      padding-bottom: 100px; /* فضای کافی برای دکمه ثابت */
    }
    ...
    /* بخش جدید: تراز وسط ایمیل و شماره تلفن */
    .contact-info {
      text-align: center;
      font-size: 1.15rem;
      margin: 40px 0;
...
<main class="content">
  ...
  <aside class="sidebar" id="sidebar">
    ...
    <h1 style="font-size:2.2rem; margin-bottom:24px; color:var(--turquoise-dark);">خدمات دبیرستان دخترانه توانش به سایر مدارس غیر دولتی</h1>

    <div style="font-size:1.15rem; line-height:2; text-align:justify; margin-bottom: 32px;">
      <p>واحد فناوری اطلاعات این دبیرستان برای اولین بار در منطقه اقدام به طراحی سیستم حقوق و دستمزد ویژه کادر اجرایی و آموزشی نموده و آمادگی این را دارد که در صورت درخواست سایر مدارس غیردولتی برای پیاده‌سازی آن در سراسر کشور اقدام نماید.</p>
      <p>&nbsp;نمونه تصاویر مربوط به فرم ورود اطلاعات و گزارش‌های خروجی سیستم مذکور از جمله فیش حقوقی در ادامه قابل مشاهده است.</p>
      <p>&nbsp;</p>
      <p>یکی دیگر از اقدامات این دبیرستان طراحی سیستم جامع مدیریت مدرسه شامل مواردی از قبیل:</p>
      <p>بانک اطلاعات دانش آموزان ، کارکنان ، مدیریت شهریه و اقساط ، سیستم ارسال پیامک به والدین و ... است</p>
      <p>&nbsp;</p>
    </div>

    <!-- بخش اطلاعات تماس وسط‌چین شده -->
    <div class="contact-info">
      <p>جهت کسب اطلاعات بیشتر و هر گونه درخواست همکاری با معاونت فناوری اطلاعات دبیرستان تماس بگیرید.</p>
      <p>admin@tavanesh-sch.ir</p>
      <p>mm.saeidi@gmail.com</p>
      <p>09131426510</p>
    </div>

    <!-- تصاویر وسط‌چین شده -->
    <div class="images-container">
      <img src="images/payroll-01.jpg" alt="نمونه فرم ورود اطلاعات">
      <img src="images/payroll-02.jpg" alt="نمونه فیش حقوقی">
      <img src="images/payroll-03.jpg" alt="نمونه لیست بانک">
      <img src="images/payroll-04.jpg" alt="نمونه فرم داده های پایه">
      <img src="images/database1.jpg" alt="نمونه فرم بانک اطلاعات جامع مدرسه ۱">
      <img src="images/database2.jpg" alt="نمونه فرم بانک اطلاعات جامع مدرسه ۲">
      <img src="images/database3.jpg" alt="نمونه فرم بانک اطلاعات جامع مدرسه ۳">
      <img src="images/database4.jpg" alt="نمونه فرم بانک اطلاعات جامع مدرسه ۴">
      <img src="images/database5.jpg" alt="نمونه فرم بانک اطلاعات جامع مدرسه ۵">
      <img src="images/database6.jpg" alt="نمونه فرم بانک اطلاعات جامع مدرسه ۶">
    </div>
