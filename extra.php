...
<head>
  ...
  <title>دبیرستان دخترانه توانش — کلاس‌های فوق‌برنامه</title>
  ...
  <style>
    :root{
      ...
      /* رنگ‌های دکمه ثابت (هماهنگ با contactus.php و weekly.php) */
...
<main class="content">
  ...
  <aside class="sidebar" id="sidebar">
    ...
    <h1 style="font-size:2.2rem; margin-bottom:24px; color:var(--turquoise-dark);">برنامه کلاس‌های فوق‌برنامه</h1>

    <!-- تصاویر وسط‌چین شده -->
    <div class="images-container">
      <img src="images/extra06.jpg" alt="برنامه کلاس‌های فوق‌برنامه ۱">
    </div>
    <div class="images-container">
      <img src="images/extra07.jpg" alt="برنامه کلاس‌های فوق‌برنامه ۲">
    </div>
    <div class="images-container">
      <img src="images/extra08.jpg" alt="برنامه کلاس‌های فوق‌برنامه ۳">
    </div>
    <div class="images-container">
      <img src="images/extra09.jpg" alt="برنامه کلاس‌های فوق‌برنامه ۴">
    </div>
