...
<head>
  ...
  <title> پایه دوازدهم — دبیرستان دخترانه توانش</title>
...
<main class="content">
  ...
  <div class="coming-soon">
    <h3>⏳ محتوا در دست تهیه است</h3>
    <p>ویدیوهای آموزشی پایه دوازدهم به‌زودی در این بخش بارگذاری خواهند شد.<br>لطفاً پس از مدتی دوباره بازدید کنید.</p>
  </div>
