...
<main class="content">
  ...
  <main class="content" class="content">
    <section class="learning-section">
      <h2>📚محتواهای آموزشی ویژه کنکور</h2>
      <!۰۱۲۳۴۵۶۷۸۹-->

        <div class="grades-grid">
          <div class="grade-card">
            <h3>مشاوره تحصیلی ریاضی- ۱</h3>
            <div id="34236591003">
              <script type="text/JavaScript"
                src="https://www.aparat.com/embed/zjya776?data[rnddiv]=34236591003&data[responsive]=yes&recom=self"></script>
            </div>
          </div>

          <div class="grade-card">
            <h3>ریاضی (علوم انسانی)</h3>
            <a href="P10-RE.php">مشاهده </a>
          </div>

          <div class="grade-card">
            <h3>ریاضی (تجربی و ریاضی)</h3>
            <a href="P10-RM.php">مشاهده </a>
          </div>

          <div class="grade-card">
            <h3>هندسه (ریاضی)</h3>
            <a href="P10-HR.php">مشاهده </a>
          </div>

          <div class="grade-card">
            <h3>فیزیک (تجربی)</h3>
            <a href="P10-FM.php">مشاهده </a>
          </div>

          <div class="grade-card">
            <h3>فیزیک (ریاضی)</h3>
            <a href="P10-FR.php">مشاهده </a>
          </div>

          <div class="grade-card">
            <h3>شیمی</h3>
            <a href="P10-C.php">مشاهده </a>
          </div>
          <div class="grade-card">
            <h3>زیست شناسی</h3>
            <a href="P10-Z.php">مشاهده </a>
          </div>
          <div class="grade-card">
            <h3>زبان انگلیسی</h3>
            <a href="P10-E.php">مشاهده </a>
          </div>
          </header>
          <br>
          <br>
