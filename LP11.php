...
<main class="content">
  ...
  <main class="content" class="content">
    <section class="learning-section">
      <h2>📚محتواهای آموزشی پایه یازدهم</h2>

      <div class="grades-grid">

        <div class="grade-card">
          <h3>ریاضی (علوم انسانی)</h3>
          <a href="P11-RE.php">مشاهده </a>
        </div>

        <div class="grade-card">
          <h3>ریاضی (تجربی)</h3>
          <a href="P11-RT.php">مشاهده </a>
        </div>

        <div class="grade-card">
          <h3>آمار (ریاضی)</h3>
          <a href="P11-AMA.php">مشاهده </a>
        </div>

        <div class="grade-card">
          <h3>حسابان (ریاضی)</h3>
          <a href="P11-HES.php">مشاهده </a>
        </div>

        <div class="grade-card">
          <h3>هندسه (ریاضی)</h3>
          <a href="P11-HR.php">مشاهده </a>
        </div>

        <div class="grade-card">
          <h3>فیزیک (تجربی)</h3>
          <a href="P11-FM.php">مشاهده </a>
        </div>

        <div class="grade-card">
          <h3>فیزیک (ریاضی)</h3>
          <a href="P11-FR.php">مشاهده </a>
        </div>

        <div class="grade-card">
          <h3>شیمی</h3>
          <a href="P11-C.php">مشاهده </a>
        </div>
        <div class="grade-card">
          <h3>زیست شناسی</h3>
          <a href="P11-Z.php">مشاهده </a>
        </div>
        <div class="grade-card">
          <h3>زبان انگلیسی</h3>
          <a href="P11-E.php">مشاهده </a>
        </div>
