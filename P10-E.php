...
<main class="content">
  ...
  <main class="content" class="content">
    <section class="learning-section">
      <h2>📚 زبان انگلیسی پایه دهم درس چهارم</h2>

      <div class="grades-grid">

        <div class="grade-card">
          <h3>قسمت اول</h3>
<div id="58037757488"><script type="text/JavaScript" src="https://www.aparat.com/embed/kpx0znm?data[rnddiv]=58037757488&data[responsive]=yes&titleShow=true"></script></div>
        </div>

        <div class="grade-card">
          <h3>قسمت دوم</h3>
<div id="46687870336"><script type="text/JavaScript" src="https://www.aparat.com/embed/pyi1i4x?data[rnddiv]=46687870336&data[responsive]=yes&titleShow=true"></script></div>
        </div>

        <div class="grade-card">
          <h3>قسمت سوم</h3>
<div id="72601897023"><script type="text/JavaScript" src="https://www.aparat.com/embed/kwms17t?data[rnddiv]=72601897023&data[responsive]=yes&titleShow=true"></script></div>
        </div>


        <div class="grade-card">
          <h3>قسمت چهارم</h3>
<div id="87306079991"><script type="text/JavaScript" src="https://www.aparat.com/embed/ceb2328?data[rnddiv]=87306079991&data[responsive]=yes&titleShow=true"></script></div>
        </div>

        <div class="grade-card">
          <h3>قسمت پنجم</h3>
<div id="84674391150"><script type="text/JavaScript" src="https://www.aparat.com/embed/zkw3t9h?data[rnddiv]=84674391150&data[responsive]=yes&titleShow=true"></script></div>
        </div>
