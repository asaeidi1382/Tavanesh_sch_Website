...
<main class="content">
  ...
  <main class="content" class="content">
    <section class="learning-section">
      <h2>📚زیست شناسی یازدهم تجربی</h2>

      <div class="grades-grid">

        <div class="grade-card">
          <h3>فصل ششم قسمت اول</h3>
<div id="97231694264"><script type="text/JavaScript" src="https://www.aparat.com/embed/yvi0dp6?data[rnddiv]=97231694264&data[responsive]=yes&titleShow=true"></script></div>
        </div>

        <div class="grade-card">
          <h3>فصل ششم قسمت دوم</h3>
<div id="52606847564"><script type="text/JavaScript" src="https://www.aparat.com/embed/odi8e8q?data[rnddiv]=52606847564&data[responsive]=yes&titleShow=true"></script></div>
        </div>


        <div class="grade-card">
          <h3>فصل ششم قسمت سوم</h3>
<div id="93088459176"><script type="text/JavaScript" src="https://www.aparat.com/embed/kxqjib3?data[rnddiv]=93088459176&data[responsive]=yes&titleShow=true"></script></div>
        </div>
