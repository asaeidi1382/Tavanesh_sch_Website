...
<head>
  ...
  <title>گالری مراسم و مناسبتها - دبیرستان توانش</title>
  ...
  <style>
    ...
    .gallery {
      display: grid;
      grid-template-columns: repeat(4, 1fr); /* پیش‌فرض چهار ستونه */
      gap: 14px;
      padding: 16px;
      max-width: 1400px;
      margin: 0 auto 40px;
...
<main class="content">
  ...
  <script>
    // مسیر و نام‌گذاری برای پوسترها
    const basePath = "images/ceremonies/";
    const startIndex = 1;
    const endIndex = 80; // تعداد تصاویر این گالری را اینجا تنظیم کن

    // نام فایل‌ها با صفرهای پیشرو: Tavanesh-ceremonies-001.jpg
    function pad3(n){ return n.toString().padStart(3, '0'); }
    function fileName(n){ return `Tavanesh-ceremonies-${pad3(n)}.jpg`; }
