...
<main class="content">
  ...
  <main class="content" class="content">
    <section class="learning-section">
      <h2>📚محتواهای آموزشی پایه دوازدهم</h2>

      <div class="grades-grid">

        <div class="grade-card">
          <h3>ریاضی (تجربی)</h3>
          <a href="P12-R.php">مشاهده </a>
        </div>

        <div class="grade-card">
          <h3>فیزیک (تجربی)</h3>
          <a href="P12-FT.php">مشاهده </a>
        </div>

        <div class="grade-card">
          <h3>شیمی</h3>
          <a href="P12-C.php">مشاهده </a>
        </div>
        <div class="grade-card">
          <h3>زیست شناسی</h3>
          <a href="P12-Z.php">مشاهده </a>
        </div>
        <div class="grade-card">
          <h3>زبان انگلیسی</h3>
          <a href="P12-E.php">مشاهده </a>
        </div>
