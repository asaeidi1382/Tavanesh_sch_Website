...
<main class="content">
  ...
  <main class="content" class="content">
    <section class="learning-section">
      <h2>📚 ریاضی دهم انسانی</h2>

      <div class="grades-grid">

        <div class="grade-card">
          <h3>قسمت اول - رسم نمودار</h3>
<div id="70966152824"><script type="text/JavaScript" src="https://www.aparat.com/embed/dau83w4?data[rnddiv]=70966152824&data[responsive]=yes&titleShow=true"></script></div>
        </div>

        <div class="grade-card">
          <h3>قسمت دوم - رسم نمودار</h3>
<div id="71921947338"><script type="text/JavaScript" src="https://www.aparat.com/embed/vxzyoqd?data[rnddiv]=71921947338&data[responsive]=yes&titleShow=true"></script></div>
        </div>

        <div class="grade-card">
          <h3>قسمت سوم - رسم نمودار</h3>
<div id="86022653988"><script type="text/JavaScript" src="https://www.aparat.com/embed/qfy1tqg?data[rnddiv]=86022653988&data[responsive]=yes&titleShow=true"></script></div>
        </div>
