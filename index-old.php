...
<!-- بقیه کد همان قبلی است، بدون تغییر -->
  ...
  <aside class="sidebar" id="sidebar">
    ...
    <section class="quick-links">
      ...
      <a class="quick-link" href="login.php">ورود کاربران</a>
      <a class="quick-link" href="news.php">اخبار توانش</a>
      <a class="quick-link" href="contactus.php">تماس با ما</a>
    </section>
    ...
    <footer>
      <div class="contact">
        ...
        <div class="contact-item"><strong>ایمیل:</strong> tavaneshhs@gmail.com</div>
        <div class="contact-item"><strong>ایمیل:</strong> modir@tavanesh-sch.ir</div>
        <div class="contact-item"><strong>اینستاگرام:</strong> tavanesh_highschool</div>
