...
<main class="content">
  ...
  <main class="content" class="content">
    <section class="learning-section">
      <h2>📚زبان انگلیسی پایه یازدهم- امتحان نهایی</h2>

      <div class="grades-grid">

        <div class="grade-card">
          <h3>قسمت اول</h3>
<div id="39605716657"><script type="text/JavaScript" src="https://www.aparat.com/embed/gieo810?data[rnddiv]=39605716657&data[responsive]=yes&titleShow=true"></script></div>
        </div>

        <div class="grade-card">
          <h3>قسمت دوم</h3>
<div id="73297706020"><script type="text/JavaScript" src="https://www.aparat.com/embed/jkw5f8r?data[rnddiv]=73297706020&data[responsive]=yes&titleShow=true"></script></div>
        </div>

        <div class="grade-card">
          <h3>قسمت سوم</h3>
<div id="92765415446"><script type="text/JavaScript" src="https://www.aparat.com/embed/hfhw619?data[rnddiv]=92765415446&data[responsive]=yes&titleShow=true"></script></div>
        </div>


        <div class="grade-card">
          <h3>قسمت چهارم</h3>
<div id="50365402708"><script type="text/JavaScript" src="https://www.aparat.com/embed/xndvn79?data[rnddiv]=50365402708&data[responsive]=yes&titleShow=true"></script></div>
        </div>
