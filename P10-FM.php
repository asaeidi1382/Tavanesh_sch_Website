    ...
    <section class="learning-section">
      ...
      <div class="grades-grid">
        ...
        <div class="grade-card">
          <h3>فصل گرما قسمت اول</h3>
<div id="84972729302"><script type="text/JavaScript" src="https://www.aparat.com/embed/ois6925?data[rnddiv]=84972729302&data[responsive]=yes&titleShow=true"></script></div>
        </div>

        <div class="grade-card">
          <h3>فصل گرما قسمت دوم</h3>
<div id="68221595405"><script type="text/JavaScript" src="https://www.aparat.com/embed/jcp1qo1?data[rnddiv]=68221595405&data[responsive]=yes&titleShow=true"></script></div>
        </div>

        <div class="grade-card">
          <h3>فصل گرما قسمت سوم</h3>
<div id="13558902787"><script type="text/JavaScript" src="https://www.aparat.com/embed/mrd90uu?data[rnddiv]=13558902787&data[responsive]=yes&titleShow=true"></script></div>
        </div>

        <div class="grade-card">
          <h3>فصل گرما قسمت چهارم</h3>
<div id="72309258603"><script type="text/JavaScript" src="https://www.aparat.com/embed/hzs839w?data[rnddiv]=72309258603&data[responsive]=yes&titleShow=true"></script></div>
        </div>

        <div class="grade-card">
          <h3>فصل گرما قسمت پنجم</h3>
<div id="85557207951"><script type="text/JavaScript" src="https://www.aparat.com/embed/xih3y6r?data[rnddiv]=85557207951&data[responsive]=yes&titleShow=true"></script></div>
        </div>
        <div class="grade-card">

          <h3>فصل گرما قسمت ششم</h3>
<div id="58883956869"><script type="text/JavaScript" src="https://www.aparat.com/embed/clb5tvz?data[rnddiv]=58883956869&data[responsive]=yes&titleShow=true"></script></div>
        </div>

        <div class="grade-card">
          <h3>فصل گرما قسمت هفتم</h3>
<div id="42665183350"><script type="text/JavaScript" src="https://www.aparat.com/embed/hyh894n?data[rnddiv]=42665183350&data[responsive]=yes&titleShow=true"></script></div>
        </div>
    ...
    <a href="lp10.php" class="fixed-back-home">
