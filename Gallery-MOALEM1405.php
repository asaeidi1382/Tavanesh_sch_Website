...
<head>
  ...
  <title>گالری بزرگداشت روز معلم - دبیرستان توانش</title>
  ...
  <style>
    ...
    .home-btn:hover {
      ...
      color: var(--turquoise-700);          /* پیشنهاد دوم: رنگ متن ثابت می‌ماند */
    }
    ...
    .btn {
      ...
      font-size: 14px;
      font-family: "Vazirmatn", system-ui, sans-serif;
      font-weight: 500;               /* نیمه‌بولد برای دکمه‌ها */
    ...
    @media (min-width: 640px) {
      ...
      .home-btn:hover {
        ...
        color: var(--turquoise-700);   /* ثابت در دسکتاپ هم */
      }
    }
...
<main class="content">
  ...
  <script>
    const basePath = "images/moalem1405/";
    const startIndex = 1;
    const endIndex = 65;

    function pad2(n){ return n.toString().padStart(2, '0'); }
    function fileName(n){ return `Tavanesh-moalem1405-${pad2(n)}.jpg`; }
