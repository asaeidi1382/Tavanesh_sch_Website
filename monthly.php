...
<head>
  ...
  <title>دبیرستان دخترانه توانش — تقویم آزمون‌ها</title>
...
<main class="content">
  ...
  <aside class="sidebar" id="sidebar">
    ...
    <h1 style="font-size:2.2rem; margin-bottom:24px; color:var(--turquoise-dark);">تقویم آزمون‌های ماهانه</h1>

    <!-- تصاویر وسط‌چین شده -->
    <div class="images-container">
      <img src="images/monthly1.jpg" alt="تقویم آزمون‌های ماهانه مهر">
      <img src="images/monthly2.jpg" alt="تقویم آزمون‌های ماهانه آبان">
      <img src="images/monthly3.jpg" alt="تقویم آزمون‌های ماهانه آذر">

      <img src="images/nobat1.jpg" alt="نوبت اول">
    </div>


<!-- دکمه ثابت بازگشت به صفحه اصلی (دقیقاً مشابه صفحات weekly و extra و contactus) -->
