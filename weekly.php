...
<head>
  ...
  <title>دبیرستان دخترانه توانش </title>
  ...
  <style>
    :root{
      ...
      /* رنگ‌های مشابه صفحه تماس با ما برای دکمه ثابت */
    ...
    *{ box-sizing: border-box; margin:0; padding:0; }
    body{
      ...
      line-height: 1.7;
      position: relative;
      padding-bottom: 100px; /* فضای کافی برای دکمه ثابت پایین صفحه */
    }
    ...
    /* دکمه ثابت بازگشت به صفحه اصلی (مشابه صفحه تماس با ما) */
    .fixed-back-home{
      position:fixed;
      bottom:30px;
      left:50%;
...
<main class="content">
  ...
  <aside class="sidebar" id="sidebar">
    ...
    <h1 style="font-size:2.2rem; margin-bottom:24px; color:var(--turquoise-dark);">برنامه هفتگی کلاسهای عادی</h1>
    <!-- تصاویر وسط‌چین شده -->
    <div class="images-container">
      <img src="images/weekly-program.jpg" alt="برنامه هفتگی کلاس‌های عادی">
    </div>
...
<!-- برای آیکون خانه در دکمه (مشابه صفحه تماس با ما که از Font Awesome استفاده کرده بود) -->
