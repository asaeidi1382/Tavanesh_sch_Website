    ...
    <section class="learning-section">
      ...
      <div class="grades-grid">
        ...
        <div class="grade-card">
          <h3>ایفوگرافیکهای شیمی دهم</h3>

	<div class="poster-images">
		<img src="images/posters/Tavanesh-poster-info-1.jpg" alt="اینفوگرافیگ شیمی دهم " >
        </div>
	<br>
	<div class="poster-images">
		<img src="images/posters/Tavanesh-poster-info-2.jpg" alt="اینفوگرافیگ شیمی دهم " >
        </div>
	<br>
	<div class="poster-images">
		<img src="images/posters/Tavanesh-poster-info-3.jpg" alt="اینفوگرافیگ شیمی دهم " >
        </div>
	<br>
	<div class="poster-images">
		<img src="images/posters/Tavanesh-poster-info-4.jpg" alt="اینفوگرافیگ شیمی دهم " >
        </div>
	<br>
	<div class="poster-images">
		<img src="images/posters/Tavanesh-poster-info-5.jpg" alt="اینفوگرافیگ شیمی دهم " >
        </div>
	<br>
        </div>
        </div>
