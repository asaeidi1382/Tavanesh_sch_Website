...
<head>
  ...
  <title>گالری پوسترها - دبیرستان توانش</title>
...
<main class="content">
  ...
  <script>
    ...
    const basePath = "images/posters/";
    const startIndex = 1;
    const endIndex = 80; // تعداد تصاویر این گالری را اینجا تنظیم کن

    // نام فایل‌ها با صفرهای پیشرو: Tavanesh-poster-001.jpg
    function pad3(n){ return n.toString().padStart(3, '0'); }
    function fileName(n){ return `Tavanesh-poster-${pad3(n)}.jpg`; }
