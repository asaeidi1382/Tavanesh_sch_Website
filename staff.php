...
<head>
  ...
  <title>دبیرستان دخترانه توانش — کادر اجرایی</title>
...
<main class="content">
  ...
  <aside class="sidebar" id="sidebar">
    ...
    <h1 style="font-size:2.2rem; margin-bottom:24px; color:var(--turquoise-dark);">معرفی کادر اجرایی</h1>
    ...
    <div class="staff-grid">
      ...
      <div class="staff-card">
        <img src="images/staff/mirzayi-m.jpg" alt="سرکار خانم فاطمه میرزایی">
        <div class="staff-info">
          <h3>سرکار خانم فاطمه میرزایی</h3>
          <p class="position">مؤسس دبیرستان دخترانه توانش</p>
          <p class="bio">بیش از ۲۰ سال سابقه تدریس ریاضی و مسئولیتهای مختلف در آموزش و پرورش</p>
        </div>
      </div>

      <!-- نفر دوم -->
      <div class="staff-card">
        <img src="images/staff/saeidi.jpg" alt="سرکار خانم فاطمه سعیدی">
        <div class="staff-info">
          <h3>سرکار خانم فاطمه سعیدی</h3>
          <p class="position">مدیر دبیرستان دخترانه توانش</p>
          <p class="bio">کارشناس ارشد شیمی فیزیک</p>
          <p class="bio">مدرس زبان انگلیسی </p>
          <p class="bio">با بیش از 18 سال سابقه تدریس و مدیریت&nbsp;</p>
        </div>
      </div>

      <!-- نفر سوم -->
      <div class="staff-card">
        <img src="images/staff/hashemi.jpg" alt="سرکار خانم زهره هاشمی">
        <div class="staff-info">
          <h3>سرکار خانم زهره هاشمی</h3>
          <p class="position">معاون  اجرایی</p>
          <p class="bio">کارشناس ارشد فیزیک</p>
          <p class="bio">با بیش از 10 سال سابقه &nbsp;</p>
        </div>
      </div>
