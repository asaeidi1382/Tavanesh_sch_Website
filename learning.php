...
<main class="content">
  ...
  <main class="content" class="content">
    <section class="learning-section">
      <h2>📚 محتواهای آموزشی اختصاصی توانش </h2>

      <div class="grades-grid">

        <div class="grade-card">
          <h3>پایه دهم</h3>
          <p>درس‌های عمومی و اختصاصی</p>
          <a href="LP10.php">مشاهده </a>
        </div>

        <div class="grade-card">
          <h3>پایه یازدهم</h3>
          <p>درس‌های عمومی و اختصاصی</p>
          <a href="LP11.php">مشاهده </a>
        </div>

        <div class="grade-card">
          <h3>پایه دوازدهم</h3>
          <p>درس‌های عمومی و اختصاصی</p>
          <a href="LP12.php">مشاهده </a>
        </div>

        <div class="grade-card">
          <h3>ویژه کنکور</h3>
          <p>آزمون‌های آزمایشی، نکات کلیدی و تست‌زنی</p>
          <a href="Lkon.php">مشاهده </a>
        </div>

        <div class="grade-card">
          <h3>ویژه امتحانات نهایی</h3>
          <p>خلاصه‌نویسی، نمونه سوال و ...</p>
          <a href="LFinal.php">مشاهده </a>
        </div>

        <div class="grade-card">
          <h3>کتابهای درسی</h3>
          <p>دانلود کتابهای درسی به فرمت پی دی اف</p>
          <a href="BooksDL.php">ورود به کتابخانه</a>
        </div>
