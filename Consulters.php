...
<head>
  ...
  <title>دبیرستان دخترانه توانش — معرفی گروه مشاوران</title>
  ...
  <style>
    ...
    *{ box-sizing: border-box; margin:0; padding:0; }
    ...
    .hamburger{ display:none; cursor:pointer; width:50px; height:50px; border-radius:16px; background: rgba(255,255,255,0.2); border:1px solid rgba(255,255,255,0.4); display:flex; align-items:center; justify-content:center; box-shadow: var(--shadow-sm); transition: var(--transition); }
    ...
    .layout{ max-width: 1400px; margin:32px auto; padding:0 16px; display:grid; grid-template-columns:1fr; gap:28px; }
    ...
    main.content{ background: var(--turquoise-lighter); border-radius:20px; padding:40px; box-shadow: var(--shadow-lg); min-height: 70vh; }
    ...
    @media(max-width:991px){
      ...
      aside.sidebar{ position:fixed; top:74px; left:0; bottom:0; width:80vw; max-width:340px; transform:translateX(-100%); transition:var(--transition); z-index:1100; border-radius:0; }
      aside.sidebar.open{ transform:translateX(0); }
      .fixed-back-home { bottom: 20px; padding: 12px 30px; font-size: 1rem; }
    }
...
<main class="content">
  ...
  <aside class="sidebar" id="sidebar">
    ...
    <h1 style="font-size:2.2rem; margin-bottom:24px; color:var(--turquoise-dark);">معرفی گروه مشاوران</h1>
    <h1 style="font-size:1.2rem; margin-bottom:24px; color:var(--turquoise-dark);">مشاورین تحصیلی اختصاصی دبیرستان دخترانه توانش سوالات شما را در زمینه های گوناگون پاسخ خواهند داد.</h1>


    <div class="teachers-container">
      <div class="teacher-item">
        <img src="images/staff/masoodpoor.jpg" alt="سرکار خانم مرضیه سادات مسعود زاده">
        <div class="name">سرکار خانم مرضیه سادات مسعود زاده</div>
	<br>
	<div class="bio">
	🔹خانم مرضیه سادات مسعود زاده رتبه برتر کنکور علوم تجربی و دانشجوی داروسازی دانشگاه علوم پزشکی کرمان
	<br>
      ...
      <div class="teacher-item">
        <img src="images/staff/bahar.jpg" alt="سرکار خانم بهار حسن زاده ">
        <div class="name">سرکار خانم بهار حسن زاده</div>
	<br>
	<div class="bio">

	<br>
	🔹سرکار خانم بهار حسن زاده رتبه برتر کنکور علوم انسانی و دانشجوی دانشگاه تهران
	<br>
      ...
      <div class="teacher-item">
        <img src="images/staff/hananeh.jpg" alt="سرکار خانم حنانه مولایی ">
        <div class="name">سرکار خانم حنانه مولایی</div>
	<br>
	<div class="bio">

	<br>
	🔹سرکار خانم حنانه ملایی رتبه دو رقمی کنکور علوم انسانی و دانشجوی کارشناسی ارشد روانشناسی تربیتی دانشگاه یزد
	<br>
</div>
      ...
      <div class="teacher-item">
        <img src="images/staff/ali.jpg" alt="آقای مهندس علی سعیدی ">
        <div class="name">آقای مهندس علی سعیدی</div>
	<br>
	<div class="bio">

	<br>
	🔹آقای مهندس علی سعیدی رتبه دو رقمی کنکور ریاضی و دانشجوی کارشناسی ارشد دانشگاه صنعتی شریف
	<br>
	<br>
	<br>
</div>
	...
	✅ داشتن راهنمای کارآزموده مسیر را به سوی هدف هموارتر کرده و موفقیت را برای شما آسان تر می‌کند.



<!-- دکمه ثابت بازگشت به صفحه اصلی (دقیقاً مشابه صفحات قبلی) -->
