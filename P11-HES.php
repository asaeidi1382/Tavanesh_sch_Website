...
<main class="content">
  ...
  <main class="content" class="content">
    <section class="learning-section">
      <h2>📚حسابان یازدهم ریاضی</h2>

      <div class="grades-grid">

        <div class="grade-card">
          <h3>قسمت اول - توابع مثلثاتی</h3>
<div id="69081768842"><script type="text/JavaScript" src="https://www.aparat.com/embed/fcs5kt9?data[rnddiv]=69081768842&data[responsive]=yes&titleShow=true"></script></div>
        </div>

        <div class="grade-card">
          <h3>قسمت دوم - توابع مثلثاتی</h3>
<div id="52198681022"><script type="text/JavaScript" src="https://www.aparat.com/embed/ftaqk72?data[rnddiv]=52198681022&data[responsive]=yes&titleShow=true"></script></div>
        </div>

        <div class="grade-card">
          <h3>قسمت دوم - توابع مثلثاتی</h3>
<div id="79870254631"><script type="text/JavaScript" src="https://www.aparat.com/embed/xfcsaq4?data[rnddiv]=79870254631&data[responsive]=yes&titleShow=true"></script></div>
        </div>

        <div class="grade-card">
          <h3>قسمت چهارم - روابط مثلثاتی</h3>
<div id="70742464273"><script type="text/JavaScript" src="https://www.aparat.com/embed/wcjcz91?data[rnddiv]=70742464273&data[responsive]=yes&titleShow=true"></script></div>
        </div>

        <div class="grade-card">
          <h3>قسمت پنجم - روابط مثلثاتی</h3>
<div id="55789197870"><script type="text/JavaScript" src="https://www.aparat.com/embed/aun6c0c?data[rnddiv]=55789197870&data[responsive]=yes&titleShow=true"></script></div>
        </div>



        <div class="grade-card">
          <h3>قسمت ششم - روابط مثلثاتی</h3>
<div id="55182436789"><script type="text/JavaScript" src="https://www.aparat.com/embed/pxf1mt6?data[rnddiv]=55182436789&data[responsive]=yes&titleShow=true"></script></div>
        </div>
