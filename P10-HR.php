    ...
    <section class="learning-section">
      ...
      <div class="grades-grid">
        ...
        <div class="grade-card">
          <h3>قسمت اول</h3>
<div id="65463637237"><script type="text/JavaScript" src="https://www.aparat.com/embed/loh1f16?data[rnddiv]=65463637237&data[responsive]=yes&titleShow=true"></script></div>
        </div>

        <div class="grade-card">
          <h3>قسمت دوم</h3>
<div id="64337998422"><script type="text/JavaScript" src="https://www.aparat.com/embed/jmde8z4?data[rnddiv]=64337998422&data[responsive]=yes&titleShow=true"></script></div>
        </div>

        <div class="grade-card">
          <h3>قسمت سوم</h3>
<div id="69091176927"><script type="text/JavaScript" src="https://www.aparat.com/embed/ovcq49s?data[rnddiv]=69091176927&data[responsive]=yes&titleShow=true"></script></div>
        </div>
